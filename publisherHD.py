...
# python code for publisherHD.py
...
def on_connect(client, userdata, flags, rc):
    if rc == 0:
        ...
        # subscribes to Topic 2 in the public channel and display generated messages
...
try:
    ...
    # User 1 automatically generate and post messages to a topic in the private channel.
    ...
    # User 1 automatically generate and post messages to <Topic 1> in a public channel.
